...
// 關於URLSearchParams，avaScript 裡有提供一個原生的 URLSearchParams() 方法，後面會帶入參數，參數的內容是你想要讓這個網址後面有什麼queryString，它會幫你把一組物件參數直接組成網址上的 queryString。這種原生方法通常都是物件建構子，在使用時要用 new 的方式來產生實例，再透過 URLSearchParams.toString() 來產生 queryString
